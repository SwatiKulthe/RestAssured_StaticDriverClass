...
public class Put_Ref_Evidance {
		...
		for (int i = 0; i < 5; i++) {
			...
			if (StatusCode == 200) {
				...
				Common_Utility_Method.EvidanceCreator("Put_Ref_Evidance", Put_Req_Repository.Put_Req_TC1(), StatusCode,
						ResponseBody);
				Put_Ref_Evidance.Validator(Put_Req_Repository.Put_Req_TC1(), ResponseBody);
				break;
			}
		}
	...
	public static void Validator(String RequestBody, String ResponseBody) {// parse responsebody
